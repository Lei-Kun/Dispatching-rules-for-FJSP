...
parser.add_argument('--et_normalize_coef', type=int, default=1, help='Normalizing constant for feature LBs (end time), normalization way: fea/constant')
...
# args for PPO
parser.add_argument('--ppo_step', type=int, default=2, help='No. of envs for training')
...
parser.add_argument('--decay_ratio', type=float, default=0.96, help='decay_ratio, e.g. 0.9, 0.95')
